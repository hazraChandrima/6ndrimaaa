    ...
    return (
        (
            ...
            <div className=" p-4 mt-5 max-w-7xl flex flex-col justify-center mx-auto relative z-10 w-full ">
                ...
                <h1 className="h-20 min-[560px]:text-5xl text-4xl sm:text-6xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50 px-5">
