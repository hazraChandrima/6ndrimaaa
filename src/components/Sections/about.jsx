...
export function About() {
    ...
    return (
        <div className="h-auto flex flex-col px-4 py-20 scroll-smooth" id="about">
            ...
            <div className=" text-md min-[420px]:text-xl min-[520px]:text-2xl ml-6 min-[520px]:ml-10 min-[800px]:px-14 mt-5 font-normal text-neutral-600 dark:text-neutral-400">
